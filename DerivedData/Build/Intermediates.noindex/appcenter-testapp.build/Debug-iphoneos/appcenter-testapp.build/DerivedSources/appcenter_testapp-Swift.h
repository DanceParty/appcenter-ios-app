...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="appcenter_testapp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17appcenter_testapp11AppDelegate")
...
SWIFT_CLASS("_TtC17appcenter_testapp13SceneDelegate")
